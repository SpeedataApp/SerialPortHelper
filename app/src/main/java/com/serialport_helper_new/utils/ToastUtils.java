package com.serialport_helper_new.utils;
...
import com.serialport_helper_new.AppSph;
...
public class ToastUtils {
    ...
    public static void showShortToastSafeCenter(final @StringRes int resId) {
        Toast toast = Toast.makeText(AppSph.getInstance(), resId, Toast.LENGTH_SHORT);
    ...
    public static void showShortToastSafeCenter(final CharSequence text) {
        Toast toast = Toast.makeText(AppSph.getInstance(), text, Toast.LENGTH_SHORT);
        toast.setGravity(Gravity.CENTER, 0, 0);
        toast.show();
    }
    ...
    private static void showToast(@StringRes int resId, int duration) {
        showToast(AppSph.getInstance().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void showToast(@StringRes int resId, int duration, Object... args) {
        showToast(String.format(AppSph.getInstance().getResources().getString(resId), args), duration);
    }
    ...
    private static void showToast(CharSequence text, int duration) {
        ...
        if (sToast == null) {
            sToast = Toast.makeText(AppSph.getInstance(), text, duration);
        } else {
            sToast.setText(text);
